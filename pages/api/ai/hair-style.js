...
class HairStyleChanger {
  ...
  async changeHair({
    ...
    try {
      console.log("Starting hair change process...");
      ...
      console.log("Sending request to hairstyle API...");
      const response = await axios.post("https://hairstyleai.ai/api/change-hairstyle", requestData, {
        headers: {
          accept: "*/*",
          ...
          priority: "u=1, i",
          referer: "https://hairstyleai.ai/?utm_source=toolify",
      ...
      console.log("Hair change request successful");
      ...
      if (error.response) {
        ...
        throw new Error("No response received from hairstyle API");
      } else {
        throw error;
      }
    }
